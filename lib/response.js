...
// set http status
exports.status = (scope, inst, args, data, stream, next) => {
...
// send headers
exports.headers = (scope, inst, args, data, stream, next) => {
...
exports.trailers = (scope, inst, args, data, stream, next) => {
...
exports.pipe = (scope, state, args, data, stream, next) => {

    let err = checkData(data, [args.target]);
    if (err) {
        return next(err);
    }

    data[args.target].pipe(data.res);
...
exports.send = (scope, inst, args, data, stream, next) => {
...
exports.end = (scope, inst, args, data, stream, next) => {
